...
void (function () {
  ...
  function init (argv) {
    ...
    var src = path.join(path.dirname(fs.realpathSync(__filename)), '../src', path.sep)
    var configGenerator = require('./issue-config.js').init(argv)
  ...
  function run (argv) {
    ...
    var plugins = helper.plugins
    var src = helper.src
    var configGenerator = helper.configGenerator
